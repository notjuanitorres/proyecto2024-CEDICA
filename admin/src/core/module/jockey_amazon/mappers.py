...
class JockeyAmazonMapper:
    ...
    def from_entity(cls, jockey: JockeyAmazon) -> Dict | None:
        ...
        if JockeyAmazon:
            jockey_dict = {
                ...
                "pension_type": jockey.pension_type.value if jockey.pension_type else None,
    ...
    def to_entity(cls, data: Dict) -> JockeyAmazon:
        ...
        return JockeyAmazon(
            ...
            scholarship_percentage=data.get("scholarship_percentage"),
            ...
            pension_type=data.get("pension_type"),
